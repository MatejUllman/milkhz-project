...
INSERT into recepty(nazev,postup,dobaPripravy,narocnost,obrazek) 
VALUES('Smažené omelety','Matematika a fyzika jsou nejlepší předměty potvrdil výzkum amerických vědců.','30 min','sřední','obrazky/l.jpg');
